            ...
            return __extends(r, e),
                ...
                r._register = function(e, i) {
                    var o = e._target,
                        n = r._tweens;
                    if (i)
                        o && (o.tween_count = o.tween_count > 0 ? o.tween_count + 1 : 1), n.push(e), r._inited || (r._lastTime = t.getTimer(), t.ticker.$startTick(r.tick, null), r._inited = !0);
                    else {
                        o && o.tween_count--;
                        for (var s = n.length; s--;)
                            if (n[s] == e)
                                return void n.splice(s, 1)
                    }
                },
                ...
                r.prototype.setPosition = function(t, e) {
                    ...
                    var r = t,
                        i = !1;
                    if (r >= this.duration && (this.loop ? r %= this.duration : (r = this.duration, i = !0)), r == this._prevPos)
                        return i;
                    var o = this._prevPos;
                ...
                r.prototype._updateTargetProps = function(t, e) {
                    ...
                    if (t || 1 != e) {
                        ...
                        this.passive = !1, i = o = this._curQueueProps;
    ...
    var e = function(e) {
            ...
            return __extends(r, e),
                ...
                r.prototype.setScrollPosition = function(t, e, r) {
                    if (void 0 === r && (r = !1), (!r || 0 != t || 0 != e) && (r || this._ScrV_Props_._scrollTop != t || this._ScrV_Props_._scrollLeft != e)) {
                        ...
                        if (r) {
                            ...
                            c || ((0 >= a || a >= s) && (a = Math.max(0, Math.min(a, s))), (0 >= l || l >= n) && (l = Math.max(0, Math.min(l, n)))),
                                this._ScrV_Props_._scrollTop = a,
                                this._ScrV_Props_._scrollLeft = l
                        } else
                            this._ScrV_Props_._scrollTop = t, this._ScrV_Props_._scrollLeft = e;
                ...
                r.prototype.$setWidth = function(t) {
                    if (this.$getExplicitWidth() == t)
                        return !1;
                    var r = e.prototype.$setWidth.call(this, t);
                    return this._updateContentPosition(),
                        r
                },
                r.prototype.$setHeight = function(t) {
                    if (this.$getExplicitHeight() == t)
                        return !1;
                ...
                r.prototype.getAnimationDatas = function(t, e, r) {
                    var i = Math.abs(t),
                        ...
                        l = e + 500 * t;
                    if (0 > l || l > r)
                        for (l = e; Math.abs(t) != 1 / 0 && Math.abs(t) > a;)
                            l += t, t *= 0 > l || l > r ? s * o : s, n++;
                    else
                        n = 500 * -Math.log(a / i);
                    var c = {
    ...
    var r = function(r) {
            ...
            return __extends(i, r),
                i.prototype.load = function(r) {
                    ...
                    if (r.method != t.URLRequestMethod.GET && r.data)
                        if (r.data instanceof t.URLVariables) {
                            ...
                            t.Capabilities.runtimeType == t.RuntimeType.WEB && n.setRequestHeader("Content-Type", "multipart/form-data"), s = r.data;
                    else;
                    ...
                    n.addEventListener(t.Event.COMPLETE, function() {
                        ...
                        n.addEventListener(t.IOErrorEvent.IO_ERROR, function() {
                ...
                i.prototype.loadSound = function(e) {
                    ...
                    function n() {
                        l.removeEventListener(t.Event.COMPLETE, o, s),
                    ...
                    var s = this,
                        a = e._request.url,
                        l = new t.Sound;
                    l.addEventListener(t.Event.COMPLETE, o, s),
                ...
                i.prototype.loadTexture = function(e) {
                    ...
                    function o(r) {
                        n();
                        var i = l.data;
                        t.Capabilities.runtimeType == t.RuntimeType.WEB && i.source.setAttribute("bitmapSrc", a);
                        var o = new t.Texture;
                        o._setBitmapData(i),
                            e.data = o,
                            window.setTimeout(function() {
    ...
    var e = function(e) {
            ...
            return __extends(r, e),
                Object.defineProperty(r.prototype, "smoothing", {
                    ...
                    set: function(t) {
                        t = !!t,
                            t != this.$smoothing && (this.$smoothing = t, this.$invalidate())
                    },
                    enumerable: !0,
                    configurable: !0
                }),
                ...
                r.prototype.advanceTime = function(e) {
                    ...
                    return r.constructFrame(),
                        r.handlePendingEvent(), !1
                },
                r.prototype.advanceFrame = function() {
                    this.$currentFrameNum = this.$nextFrameNum;
                    if (!this.frameEvents || !this.frameEvents.length) return;
    ...
    var e = function(e) {
            ...
            return __extends(r, e),
                r.prototype.update = function(t) {
                    ...
                    if (this._lastTime = t, this._paused)
                        return !1;
    ...
    var e = function(e) {
            ...
            return __extends(r, e),
                ...
                Object.defineProperty(r, "runtimeType", {
                    get: function() {
                        return t.$warn(1041, "egret.MainContext.runtimeType", "egret.Capabilities.runtimeType"),
                            r._runtimeType
                    },
                    enumerable: !0,
                    configurable: !0
                ...
                r.RUNTIME_HTML5 = "runtimeHtml5",
                r.RUNTIME_NATIVE = "runtimeNative",
                r
        }
        (t.EventDispatcher);
    t.MainContext = e,
    ...
    var e = function(e) {
            ...
            return __extends(r, e),
                ...
                r.prototype.push = function(t) {
                    ...
                    1 == e.indexOf(t) && (e.push(t), t.__recycle && t.__recycle(), this._length++, 0 == this.frameCount && (this.frameCount = this.autoDisposeTime, r._callBackList.push(this)))
                },
...
! function(t) {
    function e(e, r, l) {
        for (var c = [], h = 3; h < arguments.length; h++)
            c[h - 3] = arguments[h];
        var u = {
            listener: e,
            thisObject: r,
